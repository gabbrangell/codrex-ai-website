      ...
      <div className="w-full max-w-sm">
        <div className="rounded-2xl border border-border/50 bg-card p-8 shadow-xl shadow-black/10">
          ...
          <p className="text-sm text-muted-foreground text-center mb-8">
            {mode === "signin" ? "Sign in to manage your licenses" : mode === "signup" ? "Start your Codrex AI journey" : "We'll send you a reset link"}
          </p>

          {error && (
            <div className="flex items-start gap-2 rounded-lg bg-red-500/10 border border-red-500/20 p-3 mb-4 text-sm text-red-500">
              <AlertCircle className="h-4 w-4 mt-0.5 shrink-0" />
              {error}
            </div>
          )}
          {success && (
            <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/20 p-3 mb-4 text-sm text-emerald-500 text-center">
              {success}
            </div>
          )}
