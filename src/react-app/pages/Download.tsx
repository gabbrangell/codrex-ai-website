...
const RELEASE = "https://github.com/gabbrangell/Codrex-AI/releases/download/v1.0.1";
...
const platformData = {
  macos: {
    ...
    version: "1.0.1",
    size: "~80 MB",
    filename: "Codrex AI_1.0.1_aarch64.dmg",
    downloadUrl: `${RELEASE}/Codrex AI_1.0.1_aarch64.dmg`,
    requirements: [
  ...
  windows: {
    ...
    version: "1.0.1",
    size: "~90 MB",
    filename: "Codrex AI_1.0.1_x64-setup.exe",
    downloadUrl: `${RELEASE}/Codrex AI_1.0.1_x64-setup.exe`,
    requirements: [
