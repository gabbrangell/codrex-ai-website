...
const RELEASE = "https://github.com/gabbrangell/Codrex-AI/releases/download/v1.0.4";
...
const platformData = {
  macos: {
    ...
    downloadUrl: `${RELEASE}/Codrex AI_1.0.4_aarch64.dmg`,
    requirements: [
  ...
  windows: {
    ...
    downloadUrl: `${RELEASE}/Codrex AI_1.0.4_x64-setup.exe`,
    requirements: [
