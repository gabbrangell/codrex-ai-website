...
const STORAGE = "https://qqksobcaqvqsvczbuvbf.supabase.co/storage/v1/object/public/downloads";
...
const platformData = {
  macos: {
    ...
    version: "1.0.8",
    size: "~18 MB",
    filename: "CodrexAI-1.0.8-mac.dmg",
    downloadUrl: `${STORAGE}/CodrexAI-1.0.8-mac.dmg`,
    requirements: [
  ...
  windows: {
    ...
    version: "1.0.8",
    size: "~90 MB",
    filename: "CodrexAI-1.0.8-win.exe",
    downloadUrl: `${STORAGE}/CodrexAI-1.0.8-win.exe`,
    requirements: [
