...
const sections = [
  ...
  },
  {
    ...
    content: `Codrex AI Copilot is an AI-powered interview preparation and coaching platform that provides personalized practice sessions, real-time feedback, screen analysis, and performance analytics. The Service includes desktop applications, web interfaces, and associated tools designed to help users improve their interview skills through practice and preparation.`,
  },
  {
  ...
  {
    title: "6. Acceptable Use and User Responsibility",
    content: `The Service is intended solely as a personal interview preparation and practice tool. You are solely responsible for how you choose to use the Service, including in any professional, academic, or employment context. By using the Service, you represent that your use complies with all applicable laws, regulations, and any third-party policies or agreements that may govern your conduct (including, without limitation, employer policies, platform terms of service, or academic integrity codes). Codrex AI makes no representation that use of the Service is appropriate or permissible in any particular context. You assume all risk and liability for your use. Codrex AI expressly disclaims all liability for any consequences arising from your use of the Service in any setting.`,
  },
  {
    title: "7. Prohibited Conduct",
    content: `You agree not to: (a) reverse engineer, decompile, or disassemble the Service; (b) circumvent any security measures or access controls; (c) use the Service for any unlawful purpose; (d) share your account credentials or license key with others; (e) attempt to gain unauthorized access to our systems; (f) use automated tools to access the Service without permission; (g) interfere with other users' enjoyment of the Service; (h) resell or redistribute the Service or any portion thereof.`,
  },
  {
  ...
  },
  {
    ...
    content: `THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT GUARANTEE THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE. WE DO NOT GUARANTEE ANY SPECIFIC RESULTS FROM USE OF THE SERVICE, INCLUDING BUT NOT LIMITED TO INTERVIEW SUCCESS OR EMPLOYMENT OUTCOMES. CODREX AI IS NOT RESPONSIBLE FOR ANY DECISIONS MADE BY THIRD PARTIES (INCLUDING EMPLOYERS OR INTERVIEW PLATFORMS) AS A RESULT OF YOUR USE OF THE SERVICE.`,
  },
  {
    title: "12. Limitation of Liability",
    content: `TO THE MAXIMUM EXTENT PERMITTED BY LAW, CODREX AI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER CAUSED BY USE OR INABILITY TO USE THE SERVICE, UNAUTHORIZED ACCESS TO OR ALTERATION OF YOUR DATA, OR ANY OTHER MATTER RELATING TO THE SERVICE. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE TWELVE MONTHS PRECEDING THE CLAIM.`,
  },
  {
    title: "13. Indemnification",
    content: `You agree to indemnify, defend, and hold harmless Codrex AI and its officers, directors, employees, and agents from any claims, damages, losses, or expenses (including reasonable attorneys' fees) arising out of or related to: your use of the Service; your violation of these Terms; your violation of any rights of a third party; or any claim that your use of the Service caused damage to a third party.`,
  },
  {
    title: "14. Termination",
    content: `We may terminate or suspend your access to the Service immediately, without prior notice, for any reason, including breach of these Terms. Upon termination, your right to use the Service will cease immediately. All provisions that should survive termination shall survive, including ownership, warranty disclaimers, and limitations of liability. No refunds are provided upon termination for cause.`,
  },
  {
    title: "15. Governing Law",
    content: `These Terms shall be governed by and construed in accordance with the laws of the State of Delaware, without regard to its conflict of law provisions. Any disputes arising under these Terms shall be resolved exclusively through binding arbitration under the American Arbitration Association rules, except either party may seek injunctive relief in a court of competent jurisdiction for intellectual property violations.`,
  },
  {
    title: "16. Contact Information",
    content: `If you have any questions about these Terms, please contact us at legal@codrexai.com. We aim to respond to all legal inquiries within 5 business days.`,
  },
];
